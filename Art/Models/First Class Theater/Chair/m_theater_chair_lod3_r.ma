...
//Name: m_theater_chair_lod3_r.ma
//Last modified: Sat, Feb 01, 2014 10:06:37 AM
//Codeset: 1252
requires maya "2014";
...
createNode transform -n "m_theater_chair_high_r1:SPROJ_Theater_Chairs1:group16";
...
createNode transform -n "m_theater_chair_high_r1:SPROJ_Theater_Chairs1:group3" -p
		 "m_theater_chair_high_r1:SPROJ_Theater_Chairs1:group16";
...
createNode transform -n "m_theater_chair_high_r1:SPROJ_Theater_Chairs1:polySurface35" 
		-p "|m_theater_chair_high_r1:SPROJ_Theater_Chairs1:group16|m_theater_chair_high_r1:SPROJ_Theater_Chairs1:group3";
	setAttr ".t" -type "double3" 15.89411101252 -7.5375893627648844 -20.462320103674049 ;
...
createNode mesh -n "m_theater_chair_high_r1:SPROJ_Theater_Chairs1:polySurfaceShape35" 
		-p "m_theater_chair_high_r1:SPROJ_Theater_Chairs1:polySurface35";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
...
createNode mesh -n "m_theater_chair_high_r1:SPROJ_Theater_Chairs1:polySurfaceShape36" 
		-p "m_theater_chair_high_r1:SPROJ_Theater_Chairs1:polySurface35";
	setAttr -k off ".v";
	setAttr ".io" yes;
...
createNode polyDelEdge -n "m_theater_chair_high_r:SPROJ_Theater_Chairs1:polyDelEdge6";
	setAttr ".ics" -type "componentList" 4 "e[1]" "e[7]" "e[36:39]" "e[46:49]";
	setAttr ".cv" yes;
createNode polyDelEdge -n "m_theater_chair_high_r:SPROJ_Theater_Chairs1:polyDelEdge5";
	setAttr ".ics" -type "componentList" 12 "e[25]" "e[28]" "e[31]" "e[34]" "e[37]" "e[40]" "e[43]" "e[46]" "e[49]" "e[52]" "e[55]" "e[58]";
	setAttr ".cv" yes;
createNode polyDelEdge -n "m_theater_chair_high_r:SPROJ_Theater_Chairs1:polyDelEdge4";
	setAttr ".ics" -type "componentList" 4 "e[83]" "e[88]" "e[111]" "e[114]";
	setAttr ".cv" yes;
createNode polyDelEdge -n "m_theater_chair_high_r:SPROJ_Theater_Chairs1:polyDelEdge3";
	setAttr ".ics" -type "componentList" 4 "e[81]" "e[87]" "e[116:119]" "e[126:129]";
	setAttr ".cv" yes;
createNode polyDelEdge -n "m_theater_chair_high_r:SPROJ_Theater_Chairs1:polyDelEdge2";
	setAttr ".ics" -type "componentList" 12 "e[105]" "e[108]" "e[111]" "e[114]" "e[117]" "e[120]" "e[123]" "e[126]" "e[129]" "e[132]" "e[135]" "e[138]";
	setAttr ".cv" yes;
createNode polyDelEdge -n "m_theater_chair_high_r:SPROJ_Theater_Chairs1:polyDelEdge1";
	setAttr ".ics" -type "componentList" 3 "e[161]" "e[164]" "e[178:179]";
	setAttr ".cv" yes;
createNode materialInfo -n "m_theater_chair_high_r1:materialInfo1";
createNode shadingEngine -n "m_theater_chair_high_r1:lambert2SG";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode lambert -n "m_theater_chair_high_r1:lambert2";
createNode file -n "m_theater_chair_high_r1:file1";
...
createNode place2dTexture -n "m_theater_chair_high_r1:place2dTexture1";
...
connectAttr "m_theater_chair_high_r:SPROJ_Theater_Chairs1:polyDelEdge6.out" "m_theater_chair_high_r1:SPROJ_Theater_Chairs1:polySurfaceShape35.i"
		;
connectAttr "m_theater_chair_high_r:SPROJ_Theater_Chairs1:polyDelEdge5.out" "m_theater_chair_high_r:SPROJ_Theater_Chairs1:polyDelEdge6.ip"
		;
connectAttr "m_theater_chair_high_r:SPROJ_Theater_Chairs1:polyDelEdge4.out" "m_theater_chair_high_r:SPROJ_Theater_Chairs1:polyDelEdge5.ip"
		;
connectAttr "m_theater_chair_high_r:SPROJ_Theater_Chairs1:polyDelEdge3.out" "m_theater_chair_high_r:SPROJ_Theater_Chairs1:polyDelEdge4.ip"
		;
connectAttr "m_theater_chair_high_r:SPROJ_Theater_Chairs1:polyDelEdge2.out" "m_theater_chair_high_r:SPROJ_Theater_Chairs1:polyDelEdge3.ip"
		;
connectAttr "m_theater_chair_high_r:SPROJ_Theater_Chairs1:polyDelEdge1.out" "m_theater_chair_high_r:SPROJ_Theater_Chairs1:polyDelEdge2.ip"
		;
connectAttr "m_theater_chair_high_r1:SPROJ_Theater_Chairs1:polySurfaceShape36.o" "m_theater_chair_high_r:SPROJ_Theater_Chairs1:polyDelEdge1.ip"
		;
connectAttr "m_theater_chair_high_r1:lambert2SG.msg" "m_theater_chair_high_r1:materialInfo1.sg"
		;
connectAttr "m_theater_chair_high_r1:lambert2.msg" "m_theater_chair_high_r1:materialInfo1.m"
		;
connectAttr "m_theater_chair_high_r1:file1.msg" "m_theater_chair_high_r1:materialInfo1.t"
		 -na;
connectAttr "m_theater_chair_high_r1:lambert2.oc" "m_theater_chair_high_r1:lambert2SG.ss"
		;
connectAttr "m_theater_chair_high_r1:SPROJ_Theater_Chairs1:polySurfaceShape35.iog" "m_theater_chair_high_r1:lambert2SG.dsm"
		 -na;
connectAttr "m_theater_chair_high_r1:file1.oc" "m_theater_chair_high_r1:lambert2.c"
		;
connectAttr "m_theater_chair_high_r1:file1.ot" "m_theater_chair_high_r1:lambert2.it"
		;
connectAttr "m_theater_chair_high_r1:place2dTexture1.c" "m_theater_chair_high_r1:file1.c"
		;
connectAttr "m_theater_chair_high_r1:place2dTexture1.tf" "m_theater_chair_high_r1:file1.tf"
		;
connectAttr "m_theater_chair_high_r1:place2dTexture1.rf" "m_theater_chair_high_r1:file1.rf"
		;
connectAttr "m_theater_chair_high_r1:place2dTexture1.mu" "m_theater_chair_high_r1:file1.mu"
		;
connectAttr "m_theater_chair_high_r1:place2dTexture1.mv" "m_theater_chair_high_r1:file1.mv"
		;
connectAttr "m_theater_chair_high_r1:place2dTexture1.s" "m_theater_chair_high_r1:file1.s"
		;
connectAttr "m_theater_chair_high_r1:place2dTexture1.wu" "m_theater_chair_high_r1:file1.wu"
		;
connectAttr "m_theater_chair_high_r1:place2dTexture1.wv" "m_theater_chair_high_r1:file1.wv"
		;
connectAttr "m_theater_chair_high_r1:place2dTexture1.re" "m_theater_chair_high_r1:file1.re"
		;
connectAttr "m_theater_chair_high_r1:place2dTexture1.of" "m_theater_chair_high_r1:file1.of"
		;
connectAttr "m_theater_chair_high_r1:place2dTexture1.r" "m_theater_chair_high_r1:file1.ro"
		;
connectAttr "m_theater_chair_high_r1:place2dTexture1.n" "m_theater_chair_high_r1:file1.n"
		;
connectAttr "m_theater_chair_high_r1:place2dTexture1.vt1" "m_theater_chair_high_r1:file1.vt1"
		;
connectAttr "m_theater_chair_high_r1:place2dTexture1.vt2" "m_theater_chair_high_r1:file1.vt2"
		;
connectAttr "m_theater_chair_high_r1:place2dTexture1.vt3" "m_theater_chair_high_r1:file1.vt3"
		;
connectAttr "m_theater_chair_high_r1:place2dTexture1.vc1" "m_theater_chair_high_r1:file1.vc1"
		;
connectAttr "m_theater_chair_high_r1:place2dTexture1.o" "m_theater_chair_high_r1:file1.uv"
		;
connectAttr "m_theater_chair_high_r1:place2dTexture1.ofs" "m_theater_chair_high_r1:file1.fs"
		;
relationship "link" ":lightLinker1" ":initialShadingGroup.message" ":defaultLightSet.message";
relationship "link" ":lightLinker1" ":initialParticleSE.message" ":defaultLightSet.message";
relationship "link" ":lightLinker1" "m_theater_chair_high_r1:lambert2SG.message" ":defaultLightSet.message";
relationship "shadowLink" ":lightLinker1" ":initialShadingGroup.message" ":defaultLightSet.message";
relationship "shadowLink" ":lightLinker1" ":initialParticleSE.message" ":defaultLightSet.message";
relationship "shadowLink" ":lightLinker1" "m_theater_chair_high_r1:lambert2SG.message" ":defaultLightSet.message";
connectAttr "m_theater_chair_high_r1:lambert2SG.pa" ":renderPartition.st" -na;
connectAttr "m_theater_chair_high_r1:lambert2.msg" ":defaultShaderList1.s" -na;
connectAttr "m_theater_chair_high_r1:file1.msg" ":defaultTextureList1.tx" -na;
connectAttr "m_theater_chair_high_r1:place2dTexture1.msg" ":defaultRenderUtilityList1.u"
		 -na;
// End of m_theater_chair_lod3_r.ma
